...
<div style="margin: 30px">
    ...
    <div>
        <div style="margin-top: 20px">popover功能</div>
        <g-popover>
        ...
        <g-popover position="bottom">
            <div slot="content">我是popover弹出的内容</div>
            <g-button type="primary">popover向下按钮</g-button>
        </g-popover>
        <g-popover position="left">
            <div slot="content">我是popover弹出的内容</div>
            <g-button type="primary">popover向左按钮</g-button>
        </g-popover>
    ...
    <div style="margin-top: 20px">
        <g-nav :default-selected-keys.sync="navSelected" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
            <g-nav-item name="home">首页</g-nav-item>
            <g-nav-item name="about">关于</g-nav-item>
            <g-sub-nav name="contact">
                <template slot="title">联系方式</template>
    ...
    <div style="margin-top: 20px">
        <g-nav :default-selected-keys.sync="navSelected" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" mode="vertical">
            <g-nav-item name="home">首页</g-nav-item>
            <g-nav-item name="about">关于</g-nav-item>
            <g-sub-nav name="contact">
                <template slot="title">联系方式</template>
    ...
    <div style="margin-top: 20px">
        ...
        <g-switch :value.sync="switchValue" active-color="#13ce66" inactive-color="#ff4949"></g-switch>
    </div>
    <test>
    ...
    <div style="margin-top: 20px">
        <g-tabs1 :selected.sync="selected">
            <g-tab-pane1 title="标题1" name="1">内容1</g-tab-pane1>
